...
/* level titles + ranks */
var TITLES=[[1,'Newcomer'],[3,'Curious Mind'],[5,'Prompt Explorer'],[8,'Prompt Hand'],[12,'Prompt Adept'],[18,'Prompt Pro'],[25,'Prompt Specialist'],[35,'Prompt Expert'],[50,'Prompt Master'],[65,'Prompt Sage'],[80,'Prompt Virtuoso'],[100,'PromptPilot Grandmaster']];
var ZH_TITLES={1:'新手',3:'好奇者',5:'提示语探索者',8:'提示语熟手',12:'提示语达人',18:'提示语专家',25:'提示语大师',35:'提示语高手',50:'提示语宗师',65:'提示语贤者',80:'提示语巨匠',100:'PromptPilot 宗师'};
...
(function(){
  ...
  var sp=[
   ...
   ['devotee','💠','PromptPilot Devotee','Reach level 75','PromptPilot 忠实用户','达到等级75',function(g){return g.lvl>=75;}],
...
/* 12 backgrounds. Constellation + AI1 + Live are free; the rest are a Pro feature. */
var bgVideo=null, bgDim=null, bgVig=null, bgFade=null;
var bgScrollListener=false;
var ZH_BG_NAMES={constellation:'星座',drift:'星尘漂流',aurora:'极光',coderain:'代码雨',starfield:'超空间',neural:'神经脉冲',bubbles:'气泡',waves:'波浪',orbits:'轨道',grid:'霓虹网格',ai1:'PromptPilot',live:'实时编码'};
var ZH_BG_DESCS={constellation:'飘移的光点连线',drift:'柔和上升的光点',aurora:'缓慢流动的彩色云',coderain:'下落的字符流',starfield:'星星从身旁掠过',neural:'呼吸的网络节点',bubbles:'平静上升的圆圈',waves:'层叠流动的线条',orbits:'静静旋转的粒子',grid:'复古地平线网格',ai1:'电影级 AI 视频背景',live:'真实的人在工作'};
var ES_BG_NAMES={constellation:'Constelación',drift:'Deriva estelar',aurora:'Aurora',coderain:'Lluvia de código',starfield:'Hiperespacio',neural:'Pulso neuronal',bubbles:'Burbujas',waves:'Ondas',orbits:'Órbitas',grid:'Cuadrícula neón',ai1:'PromptPilot',live:'Código en vivo'};
var ES_BG_DESCS={constellation:'Nodos flotantes unidos por luz',drift:'Partículas brillantes ascendiendo',aurora:'Nubes de color fluyendo',coderain:'Flujo de caracteres cayendo',starfield:'Estrellas pasando a gran velocidad',neural:'Red de nodos pulsante',bubbles:'Círculos ascendentes calmados',waves:'Líneas fluidas superpuestas',orbits:'Partículas orbitando',grid:'Cuadrícula de horizonte retro',ai1:'Fondo de video IA cinematográfico',live:'Persona real trabajando'};
...
var BGS = [
  ...
  { id:'ai1', name:'PromptPilot', desc:'Cinematic AI video background', free:true, isVideo:true,
    init:function(w,h){
      if(!bgVideo){
...
function buildPanel(){
  ...
  panel.innerHTML = '<div class="modal sm"><button class="x" id="ppPanelX">&times;</button>'
    + '<h2>Your progress</h2>'
    + '<div class="desc">Earn XP every time you use PromptPilot. Signed in? It syncs across your devices.</div>'
...
function buildFeedback(){
  ...
  bar.innerHTML='<button class="pp-bbtn" id="ppFbBtn" title="Send feedback to the PromptPilot team">💬 Feedback</button>'
...
function thankYou(){
  elById('ppFbForm').innerHTML='<div style="text-align:center;padding:16px 4px">'
    ...
    +'<div style="font-size:13px;color:var(--muted);margin-top:6px">We truly appreciate your use and support of PromptPilot.</div>'
...
function fbMailto(txt,email){
  try{
    location.href='mailto:zongyufred@gmail.com?subject='+encodeURIComponent('PromptPilot feedback')
